              ...
              <TabsContent value="submission" className="space-y-8">
                <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg">
                  ...
                  <ol className="list-decimal pl-6 space-y-4">
                    ...
                    <li className="text-muted-foreground">
                      All papers must be submitted online via <Link to="" className="text-primary underline hover:text-primary/80">Microsoft CMT Submission Portal</Link>.
                    </li>
                    <li className="text-muted-foreground">
                  ...
                  <h3 className="text-2xl text-primary mt-10 mb-4">Plagiarism Policy</h3>
                  <ol className="list-decimal pl-6 space-y-4">
                    <li className="text-muted-foreground">
